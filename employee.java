...
employee(String name1,int age1,String gender1,float salary1,String desination1,String address1){
emp_name=name1;
emp_age=age1;
emp_gender=gender1;
emp_salary=salary1;
...
address=sc.nextLine();
emp[i]=new employee(name,age,gender,salary,desination,address);
}
